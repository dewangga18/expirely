...
function renderErrorMessage(error: any) {
  ...
  if (error instanceof Error) {
    return (
      <>
        <h1 className={errorBoundaryClasses.title}>Expirely belum bisa membuka halaman ini</h1>
        <p className={errorBoundaryClasses.message}>
          Muat ulang halaman. Jika masalah berlanjut, kembali ke beranda dan coba lagi.
        </p>
        {import.meta.env.DEV && (
          <pre
            className={errorBoundaryClasses.details}
