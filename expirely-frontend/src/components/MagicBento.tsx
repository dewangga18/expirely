  ...
  return (
    <>
      <style>
        {`
          ...
          @media (min-width: 1024px) {
            ...
            .card-responsive[data-card-count='4'] {
              grid-template-columns: repeat(2, 1fr);
            }

            .card-responsive[data-card-count='4'] .card:nth-child(n) {
              grid-column: auto;
              grid-row: auto;
            }
          }
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2" data-card-count={items.length}>
